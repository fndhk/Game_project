...
public class InGamePauseMenu : MonoBehaviour
{
    ...
    private void PreparePauseInputLayer()
    {
        EnsureEventSystem();
        ...
        if (canvas != null)
        {
            ...
            canvas.sortingOrder = PauseMenuSortingOrder;
    ...
    private void MaintainPauseInputLayer()
    {
        Cursor.lockState = CursorLockMode.None;
        Cursor.visible = true;

        if (canvas == null || !canvas.enabled || canvas.sortingOrder != PauseMenuSortingOrder)
        {
            PreparePauseInputLayer();
        }
    }
    ...
    private Canvas CreateCanvas()
    {
        ...
        newCanvas.sortingOrder = PauseMenuSortingOrder;
